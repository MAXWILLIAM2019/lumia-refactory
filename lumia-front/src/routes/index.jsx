...
import TestEndpoints from '../pages/TestEndpoints/TestEndpoints';
import FeatureFlagsManager from '../components/FeatureFlagsManager/FeatureFlagsManager';
...
const AppRoutes = () => {
  return (
    <BrowserRouter>
      {/* Componente de gerenciamento de feature flags (visível em todas as páginas) */}
      <FeatureFlagsManager />
      ...
      <Routes>
        ...
        {/* Rota de Teste de Endpoints (apenas para administradores) */}
        <Route
