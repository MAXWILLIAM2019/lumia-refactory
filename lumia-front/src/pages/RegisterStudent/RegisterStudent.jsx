...
// import SenhaModal from '../../components/SenhaModal'; // Removido - não mais necessário
...
export default function RegisterStudent() {
  ...
  // Estado para modal de senha (removido - não mais necessário)
  ...
  // Função removida - modal de senha não mais necessário
  ...
  return (
    <div className={styles.container}>
      ...
      {/* Modal de senha removido - não mais necessário */}
        ...
        <div className={styles.formSection}>
          ...
          <div className={styles.formGroup}>
            ...
            <small className={styles.helpText}>
              Se não informar, será gerada automaticamente usando os últimos 6 dígitos do CPF
            </small>
          </div>
        </div>
