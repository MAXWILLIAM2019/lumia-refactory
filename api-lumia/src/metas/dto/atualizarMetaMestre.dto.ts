...
export class AtualizarMetaMestreDto {
  @ApiPropertyOptional({
  ...
  @ApiPropertyOptional({
    description: 'Performance esperada (0-100)',
    example: 85.5,
    minimum: 0,
    maximum: 100,
  })
  ...
  @ApiPropertyOptional({
    description: 'Total de questões planejadas',
    example: 10,
  })
  @IsOptional()
  @IsInt()
  ...
  @ApiPropertyOptional({
    description: 'Meta de questões corretas',
    example: 8,
  })
  @IsOptional()
  @IsInt()
